...
class GroupMember(BaseModel):
	groupname = ForeignKeyField(Group, on_delete='CASCADE')
	userid = ForeignKeyField(User, on_delete='CASCADE')

if __name__ == '__main__':
    db.connect()
    db.create_tables([User, Invitation, Friend, Post, Follow, Token, Group, GroupMember])
